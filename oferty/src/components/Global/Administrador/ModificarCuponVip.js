...
class ModificarCuponVip extends React.Component{
    ...
    constructor(props)
    {
        ...
        this.state ={
            ...
            campBelleza: false, campSalud: false, campComida:false, campDolar:false, id_cupon: '', open:false, value:[], Categoria:'', loading:true,
            tienda:[],imagenes:'No Disponible', imagen2: 'No Disponible', imagen3:'No Disponible', displayImage:'none',
            dataSelect:{
                AhorroOferta:'',
                Categoria:'Comida',
                Consideraciones:'',
    ...
    getCuponesSemana(){
        axiosInstance.get('/readCuponesVIP')
        .then(res =>{
    ...
    handleCupon(value){
        ...
        axiosInstance.get('/getCupones/'+ value)
        .then(res => {
    ...
    updatePromo(){
        if(!this.state.id_cupon){
            ...
            if(!this.state.dataSelect.Titulo || !this.state.dataSelect.Detalles || !this.state.dataSelect.Descripcion ||
                ...
                if(this.state.value.length <= 0){
                    ...
                    axiosInstance.post('/refreshCuponesVip',{
                    ...
                    .then(res => {
                        swal2.fire({title:"¡Cupon modificado correctamente!",icon:"success"})
                        .then(resultado => {
                        ...
                        swal2.fire({title:"Ha ocurrido un error, favor intente de nuevo",icon:"error"})
                        .then(resultado => {
                            if(resultado.isConfirmed){
                            window.location.reload();
                            window.scrollTo(0, 0)
                                    ...
                                    <div className="col-12">
                                        <div className="card">
                                            <div className="card-header">
                                                <h4>Cupones Destacados</h4>
                                            </div>

                                            <div className="categories">
                                                <ul>
                                                    <li>
                                                        <Link to="Administrador-CuponVip" data-filter="*">Crear Cupón</Link>
                                                    </li>
                                                    <li className="active">
                                                        <Link to="Administrador-ModificarCuponVip" data-filter=".web-design">Modificar Cupones</Link>
                                                    </li>
                                                    <li>
                                                        <Link to="Administrador-AgregarCuponVip" data-filter="*">Agregar Cupón Existente</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                                                ...
                                                                <div className="products">
                                                                    ...
                                                                    <div className="product-image">
                                                                        <div className="image">
                                                                            ...
                                                                            onClick={this.handleCupon.bind(this, i)}/>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div className="form-group row mb-4">
                                                <div id="contenedor_btn" className="col-sm-12 col-md-12">
                                                    <button id="ModificarBanner" className="btn btn-primary" onClick={this.updatePromo}>Modificar Cupón</button>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
...
export default ModificarCuponVip;