...
class AgregarECuponVip extends React.Component{
    ...
    handleChangeCheckbox(event){
        this.setState({show:false, showButton:false});
    ...
    getAddCupones(){
        ...
        if(this.state.stateCupon === "Nuevo"){
            ...
            axiosInstance.post('/agregarECuponesVip', {
            ...
            axiosInstance.post('/changeCuponesVip', {
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div id="checxbox" className="form-group row mb-4 cuerpo-cupones" onChange={this.handleChangeCheckbox.bind(this)}>
                                                        <div className="form-group col-md-6">
                                                            <div className="custom-control custom-checkbox">
                                                                ...
                                                                <label htmlFor="cupon1"> Agregar como nuevo Cupón Destacado. </label>
                                                            </div> 
                                                        </div>
                                                        <div className="form-group col-md-6">
                                                            <div className="custom-control custom-checkbox">
                                                                <input type="radio" value="Reemplazar" name="cupones" id="cupon2"/>
                                                                <label htmlFor="cupon2">Reemplazar en un cupón destacado existente.</label>
                                                            </div>
                                                        </div> 
                                                    </div>
                                                    ...
                                                    <div id="SelectCupon" className="card-header-form" style={{display:this.state.show ? 'block' : 'none'}}>
                                                        <div className="card-body header-center">
                                                            <div className="card col-offset-3 tiendas-form">
                                                                <h5>Posición</h5>
                                                                <div className="input-group col-md-8 col-center">
...
export default AgregarECuponVip;