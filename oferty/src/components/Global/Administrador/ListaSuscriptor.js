...
class ListaSuscriptor extends React.Component{
    ...
    getAfiliados(){
        axiosInstance.get('/listAfiliados').then(res => {
        ...
        .map((afiliado, i) => {
            return(
                <tr key={i}>
                    ...
                    <td>{afiliado.tienda}</td>
                    <td>
                        <div id="Estado" className={`estado_cup badge badge-${afiliado.activo}`}>{afiliado.activo}</div>
                    </td>
                    <td>
