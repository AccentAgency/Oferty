...
class ModificarCuponDestacado extends React.Component{
        ...
        if(!this.state.id_cupon){
            ...
            if(!this.state.dataSelect.Titulo || !this.state.dataSelect.Detalles || !this.state.dataSelect.Descripcion ||
                ...
                if(!this.state.value){
                    ...
                    axiosInstance.post('/refreshCuponesDestacado',{
                                    ...
                                    <div className="col-12">
                                        <div className="card">
                                            ...
                                            <div className="categories">
                                                <ul>
                                                    <li>
                                                        <Link to="Administrador-CuponDestacado" data-filter="*">Crear Cupón</Link>
                                                    </li>
                                                    <li className="active">
                                                        <Link to="Administrador-ModificarCuponDestacado" data-filter=".web-design">Modificar Cupones</Link>
                                                    </li>
                                                    <li>
                                                        <Link to="Administrador-AgregarCuponDestacado" data-filter="*">Agregar Cupón Existente</Link>
                                                    </li>
                                                </ul>
                                            </div>
...
export default ModificarCuponDestacado;